<?php 
    ...
    try{
        ...
        <b><u>Asunto:</u> </b>Recibiste una consulta desde liderarpropiedades.cl<br/>
        ...
        <a href='http://liderarpropiedades.cl/'>www.liderarpropiedades.cl.cl</a>
        ";
        
        $mail->isSMTP();                     
        $mail->Host = 'mail.liderarpropiedades.cl';  
        $mail->SMTPAuth = true;                
        $mail->Username = 'no_reply@liderarpropiedades.cl';
        $mail->Password = 'usuario1234';                
        $mail->SMTPSecure = 'ssl';                            
        $mail->Port = 465;          
        
        $mail->SetFrom( $email , 'Un cliente quiere contactar con liderarpropiedades.cl' );
        $mail->addAddress( "contacto@liderarpropiedades.cl", 'Mensaje desde la web');   
        $mail->isHTML(true);                                 
