    ...
    <Fragment>
      <Hidden xs>
        ...
        >
          ...
          {
            Array(itemsDesk.length).fill(0).map((_,i) => <Dot style={{ backgroundColor: "#008AFC" }} className="carousel-text-dot" key={i} slide={i} />)
          }
        </CarouselProvider>
      </Hidden>
      <Visible xs>
        ...
        >
          <Slider>
            ...
            {
              Array(itemsMovil.length).fill(0).map((_,i) => <Dot style={{ backgroundColor: "#000" }} className="carousel-text-dot" key={i} slide={i} />)
            }          
          </CarouselProvider>
      </Visible>
    </Fragment>
