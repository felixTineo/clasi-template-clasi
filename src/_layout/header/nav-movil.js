...
{/*          <NavItem>
        ...
        <Link href={`tel:${state.office.phone}`}>
          <Button>
        ...
        <SocialCont>
          <SocialItem>
            <NavLink href={state.office.facebook} target="_blank" rel="noopener">
              <img src="/facebook.svg" alt="facebook" />
            </NavLink>
          </SocialItem>
          <SocialItem>
            <NavLink href={state.office.instagram} target="_blank" rel="noopener">
              <img src="/instagram.svg" alt="instagram" />
            </NavLink>
          </SocialItem> 
          <SocialItem>
            <NavLink href="https://g.page/realty-brokers-chile?gm" target="_blank" rel="noopener">
