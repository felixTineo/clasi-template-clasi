          ...
          <Row>
            ...
            <Col xs={12} md={4}>
              <Row>
                ...
                <Col xs={12}>
                  <ContactButton href="https://api.whatsapp.com/send?phone=56968980126" target="_blank" rel="noopener">
                ...
                <Col xs={12}>
                  <SocialNav>
                    ...
                    <SocialItem style={{ marginLeft: "1rem" }}>
                      <a href="https://www.facebook.com/Liderar-Propiedades-109987060417541" target="_blank" rel="noopener">
                    ...
                    <SocialItem>
                      <a href="https://www.instagram.com/liderar_propiedades/" target="_blank" rel="noopener">
                        <SvgIcon social={true} width="29" height="29" fill="none" version="1.1" viewBox="0 0 29 29" xmlns="http://www.w3.org/2000/svg">
